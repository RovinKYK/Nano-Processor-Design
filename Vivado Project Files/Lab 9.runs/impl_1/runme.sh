...
HD_PWD='D:/Sem 2/Computer organization and Digital Design/Labs Tutorials/Lab 9/Group 50/Submission/Lab 9/Lab 9/Lab 9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroProcessor.tcl -notrace
